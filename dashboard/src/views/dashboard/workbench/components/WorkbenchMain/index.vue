  ...
  <n-grid :item-responsive="true" :x-gap="16" :y-gap="16">
    <n-grid-item span="0:24 640:24 1024:16">
      <n-space :vertical="true" :size="16">
        <n-card title="Project Main Tech Stack" :bordered="false" size="small" class="shadow-sm rounded-16px">
          <template #header-extra>
            <a class="text-primary" href="javascript:;">More Tech Stack</a>
          </template>
    ...
    <n-grid-item span="0:24 640:24 1024:8">
      <n-space :vertical="true" :size="16">
        <n-card title="Quick operation" :bordered="false" size="small" class="shadow-sm rounded-16px">
          <n-grid :item-responsive="true" responsive="screen" cols="m:2 l:3" :x-gap="8" :y-gap="8">
        ...
        <n-card title="Creative" :bordered="false" size="small" class="shadow-sm rounded-16px">
...
const activity: Activity[] = [
  { id: 4, content: '今日生产计划已下达，请注意查收', time: '2022-11-07 22:45:32' },
  { id: 3, content: '2号机器刀具磨损即将达到阈值，请及时通知工人更换刀具', time: '2022-11-03 20:33:31' },
  { id: 2, content: 'OpenIE 新系统即将上线！', time: '2022-10-31 22:43:12' },
  { id: 1, content: '17号机器刀具磨损即将达到阈值，请及时通知工人更换刀具', time: '2022-10-27 10:24:54' },
  { id: 0, content: '今日生产报告已自动生成，点击查看', time: '2022-05-28 22:22:22' }
];
...
const shortcuts: Shortcuts[] = [
  ...
  { id: 1, label: '机床传感器', icon: 'ic:outline-settings', iconColor: '#7238d1' },
  { id: 2, label: '人事管理', icon: 'mdi:family-tree', iconColor: '#f56c6c' },
  { id: 3, label: '小程序', icon: 'fluent:app-store-24-filled', iconColor: '#19a2f1' },
  { id: 4, label: '生产计划', icon: 'mdi:table-large', iconColor: '#fab251' },
  { id: 5, label: '机床数据分析', icon: 'mdi:chart-areaspline', iconColor: '#8aca6b' }
];
</script>
